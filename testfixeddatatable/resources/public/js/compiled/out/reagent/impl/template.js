...
var G__26421 = o;
(G__26421[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
var G__26430 = jsprops;
(G__26430["defaultValue"] = value);

(G__26430["onChange"] = ((function (G__26430,v,value,on_change){
return (function (p1__26427_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__26427_SHARP_);
});})(G__26430,v,value,on_change))
);

(G__26430["ref"] = ((function (G__26430,v,value,on_change){
return (function (p1__26428_SHARP_){
return (this$["cljsInputElement"] = p1__26428_SHARP_);
});})(G__26430,v,value,on_change))
);
...
var vec__26437 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__26437,(0),null);
var id = cljs.core.nth.call(null,vec__26437,(1),null);
var class$ = cljs.core.nth.call(null,vec__26437,(2),null);
...
var jsprops = ({"argv": v});
var temp__4661__auto___26442 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__4661__auto___26442 == null)){
} else {
var key_26443 = temp__4661__auto___26442;
(jsprops["key"] = key_26443);
}

return (reagent.impl.util.react["createElement"])(c,jsprops);
});
reagent.impl.template.adapt_react_class = (function reagent$impl$template$adapt_react_class(c){
var G__26445 = (new reagent.impl.template.NativeWrapper());
(G__26445["name"] = c);
...
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq26449){
var G__26450 = cljs.core.first.call(null,seq26449);
var seq26449__$1 = cljs.core.next.call(null,seq26449);
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic(G__26450,seq26449__$1);
});
...
break;
default:
var G__26457 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,v,(0),cljs.core.subs.call(null,n,(pos + (1))))], null);
v = G__26457;
continue;
...
var n__25705__auto___26460 = a.length;
var i_26461 = (0);
while(true){
if((i_26461 < n__25705__auto___26460)){
(a[i_26461] = reagent.impl.template.as_element.call(null,(a[i_26461])));

var G__26462 = (i_26461 + (1));
i_26461 = G__26462;
continue;
} else {
}
...
var a = cljs.core.into_array.call(null,s);
var n__25705__auto___26463 = a.length;
var i_26464 = (0);
while(true){
if((i_26464 < n__25705__auto___26463)){
var val_26465 = (a[i_26464]);
if((cljs.core.vector_QMARK_.call(null,val_26465)) && ((reagent.impl.template.key_from_vec.call(null,val_26465) == null))){
(o["no-key"] = true);
} else {
}

(a[i_26464] = reagent.impl.template.as_element.call(null,val_26465));

var G__26466 = (i_26464 + (1));
i_26464 = G__26466;
continue;
} else {
}
...
var ctx = ({});
var vec__26470 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__26470,(0),null);
var derefed = cljs.core.nth.call(null,vec__26470,(1),null);
...
var G__26474 = (cljs.core.count.call(null,argv) - first_child);
switch (G__26474) {
case (0):
...
break;
default:
return (reagent.impl.util.react["createElement"]).apply(null,cljs.core.reduce_kv.call(null,((function (G__26474){
...
//# sourceMappingURL=template.js.map?rel=1479345920580