...
var G__38304 = devtools.prefs.pref.call(null,v);
v = G__38304;
continue;
} else {
return v;
...
}catch (e38317){var e__35908__auto__ = e38317;
return false;
}})();
...
}catch (e38321){var e__35908__auto__ = e38321;
return false;
}})();
...
}catch (e38323){var e__35908__auto__ = e38323;
return false;
}}
}
});
...
var vec__38328 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__38328,(0),null);
var name = cljs.core.nth.call(null,vec__38328,(1),null);
...
return cljs.core.some.call(null,(function (p1__38331_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__38331_SHARP_);
}),template);
});
...
//# sourceMappingURL=helpers.js.map?rel=1479345931192